              ...
              <a className="collapsible-header" draggable={typeof directory !== "string"} onDragStart={e => {
                ...
                {typeof directory !== "string" ? (
                  <ContextMenu>
                    ...
                    <li>
                      <a className="waves-effect" onClick={e => app.cut(directory)}><i className="material-icons">save_alt</i>Cut</a>
                    </li>
                    <li>
                  ...
                  {itemArray.map(file => file.type === 0 ? (
                    <li key={file.name} draggable="true" onDragStart={e => {
                      ...
                      <ContextMenu>
                        ...
                        <li>
                          <a className="waves-effect" onClick={e => app.cut(file)}><i className="material-icons">save_alt</i>Cut</a>
                        </li>
                        <li>
